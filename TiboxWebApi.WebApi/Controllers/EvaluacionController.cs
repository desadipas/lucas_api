    ...
    public class EvaluacionController : BaseController
    {
        ...
        public IHttpActionResult Evaluacion(Persona persona)
        {
            ...
            try
            {
                ...
                bool bResultado = _evaluacion.EvaluacionLucas(persona.nNroDoc,
                    persona.cDistrito,
                    persona.cProvincia,
        ...
        [Route("EvaluacionElectro")]
        [HttpPost]
        public IHttpActionResult EvaluacionElectro(Persona persona)
        {
            var FlujoRespuesta = 0;
            int nRechazado = 0;
            int nPEP = 0;
            ...
            try
            {
                ...
                bool bResultado = _evaluacion.EvaluacionElectro(persona.nNroDoc,
                    persona.cDistrito,
                    persona.cProvincia,
                    persona.cDepartamento,
                    nEdad,
                ...
                flujo.cNomform = "/StateClienteNuevo";
                flujo.nCodCred = 0;
                flujo.cUsuReg = persona.cUsuReg;
                flujo.nIdFlujo = 0;
                flujo.nCodPersReg = persona.nCodPersReg;
                flujo.nOrdenFlujo = 0;
                flujo.oScoringDatos = cXmlScoringDatos;
                flujo.oScoringVarDemo = cXMLPuntajeIPDItems;
                flujo.oScoringDetCuota = cXmlScoringCuota;
                ...
                flujo.oScoringRCC = cXmlDeudas;
                flujo.nRechazado = nRechazado;
                flujo.nCodigoVerificacion = persona.nCodigoVerificador;

                var FlujoMaestro = _unit.FlujoMaestro.ElectroRegistraMotor(flujo);
            ...
            {
                cMensajeTry = ex.Message;
                _unit.Error.InsertaError("EVALUACION - Evaluacion Electro ", ex.Message);
            }
            return Ok(new { nIdFlujoMaestro = FlujoRespuesta, nRechazado = nRechazado, cMensajeTry = cMensajeTry, nPEP = nPEP });
        }
