...
namespace TiboxWebApi.Repository.Interfaces
{
    public interface IPersonaRepository:IRepository<Persona>
    {
        ...
        IEnumerable<Persona> ElectroDatosPersona(string cDocumento);
        int ElectroInsPersona(Persona persona);
        IEnumerable<Persona> DatosDocumentacion(int nIdFlujoMaestro);
    }
}
