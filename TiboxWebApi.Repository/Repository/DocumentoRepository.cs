...
namespace TiboxWebApi.Repository.Repository
{
    ...
    {
        public IEnumerable<Documento> ElectroDocumentos()
        {
            using (var connection = new SqlConnection(_connectionString))
            {
                return connection.Query<Documento>("WebApi_DocumentosElectro_SP", null, commandType: CommandType.StoredProcedure);
            }
        }
