...
namespace TiboxWebApi.Repository.Repository
{
    public class CatalogoCodigoRepository : BaseRepository<CatalogoCodigos>, ICatalogoCodigoRepository
    {
        ...
        public IEnumerable<CatalogoCodigos> selTipoDoc()
        {
            using (var connection = new SqlConnection(_connectionString))
            {
                return connection.Query<CatalogoCodigos>("WebApi_LucasTipoDoc_SP", null, commandType: CommandType.StoredProcedure);
            }
        }
